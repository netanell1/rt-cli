...
export function createComponent(componentFullName, options) {
    ...
    if (templateComponentPath) {
        ...
        templateComponentFile = templateComponentFile.replace(/_\{\s*(functionName|styleFileName|componentName)\s*\}_/g, (match, p1) => {
            switch (p1) {
                case 'functionName':
                    return functionName;
                case 'styleFileName':
    ...
    if (templateStylePath) {
        ...
        templateStyleFile = templateStyleFile.replace(/_\{\s*(functionName|styleFileName|componentName)\s*\}_/g, (match, p1) => {
            switch (p1) {
                case 'functionName':
                    return functionName;
                case 'styleFileName':
...
function createTestFile(componentDir, componentFileName, componentName, functionName, fileExtension, testLibrary) {
